...
import com.ververica.flink.agent.flintagents.adapter.FlinkAgentsEventAdapter;
import com.ververica.flink.agent.flintagents.adapter.FlinkAgentsToolAdapter;
...
/**
 * Interactive demo showcasing the Hybrid Flink Agents Integration.
 *
 * <p>This demo simulates a customer support agent that:
 *
 * <ul>
 *   <li>Uses Flink Agents for event-driven tool execution
 *   <li>Uses our validation framework for quality assurance
 *   <li>Uses our context management for memory
 *   <li>Demonstrates seamless interoperability between both systems
 * </ul>
 *
 * <p><b>Scenario:</b> A customer support AI agent handling various customer requests with tools
 * for order lookup, refund processing, and knowledge base search.
 *
 * @author Agentic Flink Team
 */
public class InteractiveFlinkAgentsDemo {
